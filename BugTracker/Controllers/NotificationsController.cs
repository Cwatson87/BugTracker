...
namespace ShadowTracker.Controllers
{
    ...
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,NotificationTypeId,Message,Created,Viewed,TicketId,ProjectId,RecipientId,SenderId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,NotificationTypeId,Message,Created,Viewed,TicketId,ProjectId,RecipientId,SenderId")] Notification notification)
        {
